...
/// 点乘Editor绘制
/// </summary>
[CustomEditor(typeof(DotMath))]
public class DotMathEditor : Editor
{
    /// <summary>
    /// 起点对象1属性
    /// </summary>
    ...
    {   
        ...
        Handles.BeginGUI();
        EditorGUILayout.LabelField($"2个向量角度:{AngleProperty.floatValue}", GUILayout.Width(250f), GUILayout.Height(20f));
        Handles.EndGUI();
    }
}